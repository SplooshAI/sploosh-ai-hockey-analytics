# Architecture - Sploosh.AI Hockey Analytics

**Type:** Living Architecture Documentation  
**Status:** Current  
...
This is the canonical, living architecture document for Sploosh.AI Hockey
Analytics. It is updated as the system evolves to always reflect the current
state.

**Historical Snapshots:**

- [2026-01-03 Initial State](2026-01-03-initial-state.md) - Architecture at
  project start

**Architecture Decision Records:**

Significant architectural changes are documented as ADRs in this folder with
detailed context, rationale, and trade-offs. See individual ADR documents for
specific decisions.
...
This architecture document serves as a snapshot of the current state and will
be updated as the system evolves through the Q1 2026 strategic plan.
